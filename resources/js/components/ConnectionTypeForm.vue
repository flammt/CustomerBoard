    ...
    export default {
        ...
        methods: {
            save () {
                ...
                if (this.type.id) {
                    this.service.url = "json/aux/connectionType";
                    this.service.obj = this.type;
                    this.service.doPut((error, data) => {
                        if (error) {
                            console.error('Updating ConnectionType failed: ' + data);
                        } else {
                            this.$emit('reload');
                        }
                    });
                    ...
                    this.service.doPost((error, data) => {
                        if (error) {
                            console.error('Saving ConnectionType failed: ' + data);
                        } else {
                            this.$emit('reload');
                        }
                    });
            ...
            load () {
                this.service.url = "json/aux/connectionType/"+this.id;
